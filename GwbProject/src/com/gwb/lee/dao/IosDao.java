...
public class IosDao implements IosService {
	...
	public List<FavouriteBook> listFavouritebook(String userId) {
		...
		String sql = "select fb.favoriteId,u.userId,u.userName,bs.bookId,bs.bookName,bs.bookUrl,fb.createTs from books bs,users u,favouritebook fb where u.isAvailable=1 and u.userId=fb.userId and fb.bookId = bs.bookId ";
	...
	public List<FavouriteBook> deleteFavouritebook(String userId,
		...
		try {
			jdbcUtils.getConnection();
			jdbcUtils.updateByPreparedStatement(deleteSql, null);
